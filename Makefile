...
claim-ledger: stats mode-ticket-alignment-audit mask-artifact-posthoc-audit full-mask-artifact-posthoc-audit full-channel-permutation-audit exhaustive-channel-feasibility-audit digits-fullnet-laplace-summary fake-resnet-fullnet-laplace-summary linear-connectivity-audit posterior-covariance-robustness-audit mode-ticket-artifact-budget
	$(PYTHON) scripts/build_paper_claim_ledger.py
