...
5. Paper hardening.
   ...
   validation receipt, external-validation runbook, public release/source/CI
   receipts, and submission handoff now exist; remaining strict external
   hardening is independent external GPU/CUDA container validation.
