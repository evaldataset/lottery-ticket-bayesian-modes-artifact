...
| CUDA training container | 1 NVIDIA CUDA GPU with NVIDIA container runtime | `Dockerfile.gpu`, `docs/gpu_training_container.md` | Recreates the locked CUDA package stack for training and posterior runs on a GPU host. |
