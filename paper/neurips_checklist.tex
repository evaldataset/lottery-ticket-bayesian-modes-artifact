...
\item {\bf Open access to data and code}
    ...
    \item[] Justification: The local package contains the code, run artifacts, and reproduction commands, but an anonymized public supplement or repository has not yet been externally published.
