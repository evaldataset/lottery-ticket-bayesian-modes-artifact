...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "submission_notes": [
            ...
            "The public archive, public source repository, public CI, and local GPU-container receipts are filled; label the external GPU-container receipt as optional independent hardening until it exists.",
            ...
            "Do not claim strict external-validation readiness until the external GPU-host receipt passes.",
        ],
    }
