...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "submission_notes": [
            ...
            "The public archive, public source repository, and public CI receipts are filled; keep final release-readiness language conservative until the external GPU-container receipt is filled.",
